...
const TEXT = {
  en: {
    ...
    unusable_age: 'No life-table value is available for this age.',
  ...
  de: {
    unavailable: 'Einstellungen prüfen',
    check_settings: 'Plugin-Einstellungen und Daten prüfen.',
    valid_birth_date: 'Gültiges Geburtsdatum eingeben.',
    future_birth_date: 'Geburtsdatum liegt in der Zukunft.',
    select_sex: 'Männlich oder Weiblich wählen.',
    no_table_country: 'Keine Sterbetafel verfügbar für',
    no_table_sex: 'Sterbetafel verfügbar für',
    age_limit: 'Sterbetafel unterstützt Alter bis',
    unusable_age: 'Für dieses Alter ist kein Sterbetafelwert verfügbar.',
